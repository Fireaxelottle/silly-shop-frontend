...
const Navbar = () => {
  return (
    <div
      className="navbar  w-full flex justify-between items-center bg-slate-200 p-5 sticky top-0">
      ...
      <ul className="flex text-xl items-center  gap-5">
        ...
        <li>
          <Link to="/searh"><i class="fa-solid fa-magnifying-glass text-lg"></i></Link>
        </li>
